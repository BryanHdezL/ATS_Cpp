//Recorrer el arbol binario en PostOrden.

/***********************************************************************
Para recorrer un arbol bianrio en postOrden, solo hay que seguir 4 pasos:
    ...
    2. En caso de que aun no se llegue al fin del arbol, se invoca a la 
        funcion inOrden, analizando por la izquierda.
    3. Se vuelve a invocar a la funcion inOrden, analziando por la 
        derecha.
    4. Se imprime el valor del nodo analziado actualmente.
***********************************************************************/
